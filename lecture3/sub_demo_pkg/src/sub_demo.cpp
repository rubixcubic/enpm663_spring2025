 ...
 * using the rclcpp library. The SubDemoInterface class is used here to
...
#include "sub_demo_pkg/sub_demo_interface.hpp"  // Custom subscriber node header

// Allows using the 'ms' literal for milliseconds
using namespace std::chrono_literals;

//=====================================
void SubDemoInterface::leia_topic_cb(
...
int main(int argc, char *argv[]) {
  ...
  auto subscriber_node = std::make_shared<SubDemoInterface>("sub_demo_cpp");
